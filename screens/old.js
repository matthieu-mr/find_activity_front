    ...
    if (infoPlace.existe == false){ // pas de resultat google place
      ...
      <ScrollView>
        <Card>
            ...
            <View style={{display:"flex",flexDirection:"row",justifyContent:"space-around",flex:1,backgroundColor:"red"}}>
    ...
    try {
      ...
      <ScrollView>
        <Card>
            ...
            <View style={{display:"flex",flexDirection:"row", justifyContent:"space-around",flex:1,background}}>
